...
const Page =async ({params}) => {
    const id = params.id
    const movieDetail = await fetch(id)
  return (
       ...
       <Image style={{objectFit:"cover"}} fill
        ...
        <div className='absolute'>
            ...
            className='w-1/2'>
                ...
                <div className='my-4 border w-32 hover:bg-white hover:text-black p-2 rounded-md text-center text-lg cursor-pointer'>Trail</div>
        </div>
         </div>
  )
}
